...
<html>
    ...
    <body class="skin-yellow-light sidebar-mini" style="background-color: #f8f8f6;">
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                  ...
                  <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        <li><a href="#">Документо-ориентированное взаимодействие (XML)</a></li>
                    </ul>
                  </div>
                </nav>
            </header>
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li><a href="DocController?action=logout"><i class="fa fa-sign-out"></i><span>Выйти</span></a></li>
                        <li class="treeview">
                            <a href="#">
                    ...
                    <div class="box box-warning">
                        <div id="content">
                            ...
                            <div class="box-body">
                                ...
                                <p style="text-indent: 20px;">Данная страница построена на взаимодействии с веб-сервисом в документо-ориентированном стиле. Пункты меню слева позволят Вам получить доступ к
        ...
        <script type="text/javascript" src="js/doc_logic.js"></script>
    </body>
</html>
